...
# Project:  Rockbot.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile Rockbot.pro
#############################################################################
...
CXXFLAGS      = -pipe -DLINUX -DPC -Wno-reorder -Wno-ignored-qualifiers -Wno-deprecated -Wno-unused-parameter -Wno-sign-compare -fpermissive -O2 -Wall -W -fPIC $(DEFINES)
...
DISTDIR = /home/ark/rockbot/.tmp/rockbot1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib -lSDL_mixer -lSDL_image -lSDL_ttf -lSDL_gfx `sdl-config --libs` -ldl   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = docs/notes.txt \
		...
		Rockbot.pro aux_tools/fps_control.h \
		...
		scenes/game_menu.h \
		file/v4/file_castlepoints.h main.cpp \
		aux_tools/fps_control.cpp \
		character/character.cpp \
		graphicslib.cpp \
		inputlib.cpp \
...
Makefile: Rockbot.pro /usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
game_manual.o: docs/game_manual.cpp docs/game_manual.h \
		graphicslib.h \
		defines.h \
		file/format/st_common.h \
		file/format.h \
		...
		graphic/draw.h \
		strings_map.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o game_manual.o docs/game_manual.cpp
